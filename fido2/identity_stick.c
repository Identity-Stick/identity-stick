...
//This data has to be changed, if you want to store different attributes
const char AVAILABLE_DATA[] =  "{\"available-data\": [\"n-fN\",\"n-gN\",\"bD\"], \"pub_key\": \"<Add your public key here>\"}";
